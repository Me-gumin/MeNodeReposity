...
from .model_precision_converter.nodes import (
    NODE_CLASS_MAPPINGS as Precision_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as Precision_NODE_DISPLAY_NAME_MAPPINGS,
)

# 合并映射
NODE_CLASS_MAPPINGS = {
    **Nudenet_NODE_CLASS_MAPPINGS,
    **Precision_NODE_CLASS_MAPPINGS,
    "MaskOverlayNode": MaskOverlayNode,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    **Nudenet_NODE_DISPLAY_NAME_MAPPINGS,
    **Precision_NODE_DISPLAY_NAME_MAPPINGS,
